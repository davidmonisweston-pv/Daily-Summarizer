...
class EmailService {
  ...
  async sendReportEmail(to: string, topicName: string, summary: string, sources: Array<{ title: string; url: string }>) {
  ...
  private convertMarkdownToHTML(markdown: string, sources: Array<{ title: string; url: string }>): string {
      ...
      <body>
        <div class="container">
          ...
          <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #e5e7eb; font-size: 12px; color: #6b7280;">
            <p>This report was automatically generated by Daily Summarizer.</p>
          </div>
        </div>
      </body>
      </html>
